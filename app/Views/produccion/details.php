  ...
  <div class=" relative h-full pb-16 flex flex-col gap-y-8 items-center justify-center font-titil ">
  	...
  	<?php echo view('produccion/_partials/navbar_old'); ?>
		...
		<form id="form_incidencia" method="post" class="pdf-container" enctype='multipart/form-data'>
			...
			<!-- Pagina 1 -->
			<div class=" flex flex-col gap-y-8 w-full lg:w-9/12 p-3 lg:px-12 lg:py-6 bg-white drop-shadow-card">

				<div class="relative text-title w-full md:p-4 md:px-16 p-2 flex items-center ">
					<div class="hidden lg:flex gap-4 items-center absolute left-0 top-1/2 -translate-y-1/2">
					...
					<h2 class="text-center font-semibold w-full text-2xl lg:text-3xl "><?= esc($title) ?></h2>
				</div>
				...
				<div class="text-title w-full flex items-center justify-between ">
					...
					<div class="flex gap-x-4  w-1/2 items-center justify-end ">
						<div class="flex flex-col w-2/3 items-center "> 
							...
							<span class="input_modal text-title font-semibold to_uppercase text-center "><?= $reporte['name'] . ' ' . $reporte['last_name']?></span>
