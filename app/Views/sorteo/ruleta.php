...
const spin = () => {
  ...
  // 🎯 1. Elegir premio con peso
  winningIndex = elegirSeccionConPeso(duplicatedSections);

  const arcd = arc * 180 / Math.PI;

  // 🎯 2. Ángulo del centro del premio
  const targetAngle =
    360 - (winningIndex * arcd) - (arcd / 2);

  const prizeAngle = (targetAngle - 90) * Math.PI / 180;

  // 🎯 3. Vueltas completas extra (AJUSTABLE)
  const extraSpins = 5; // 🔥 aquí controlas el show
...
const stopRotateWheel = () => {
  ...
  // aseguramos el ángulo exacto final
