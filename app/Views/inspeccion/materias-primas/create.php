				...
				<div class="general__section">
					...
					<div class="general__col header border-r border-t  ">
						...
						<div class=" col w-full lg:w-[52%] border-l border-b">
							...
							<input type="text" data-field="MATERIA PRIMA" class="w-full to_uppercase text-gray h-8 lg:hidden ">
						</div>
						<div class=" col w-full lg:w-[18%] border-l border-b">
							<span>CANTIDAD (Piezas o contenedores).</span>
							<input type="text" data-field="CANTIDAD (Piezas o contenedores)" class="w-full to_uppercase text-gray h-8 lg:hidden ">
						</div>
						<div class=" col w-full lg:w-[15%] border-l border-b">
							<span>CANTIDAD TOTAL (Kg o L)</span>
							<input type="text" data-field="CANTIDAD TOTAL (Kg o L)" class="w-full to_uppercase text-gray h-8 lg:hidden ">
						</div>
					</div>
					...
					<div class="general__row border-r">
						...
						<div class="col border-l border-b w-[52%]">
							<input type="text" data-field="MATERIA PRIMA" class="w-full to_uppercase h-8">
						</div>
						<div class="col border-l border-b w-[18%]">
							<input type="text" data-field="CANTIDAD (Piezas o contenedores)" class="w-full to_uppercase h-8">
						</div>
						<div class="col border-l border-b w-[15%]">
							<input type="text" data-field="CANTIDAD TOTAL (Kg o L)" class="w-full to_uppercase h-8">
						</div>
					</div>
					...
					<div class="general__col header border-r">
						<div class="col border-l border-b w-full lg:w-[15%]">
							...
							<input type="text" data-field="FECHA DE ARRIBO" class="w-full to_uppercase text-gray h-8 lg:hidden" value="<?= date('d-m-Y'); ?>">
						</div>
						<div class="col border-l border-b w-full lg:w-[28%]">
							<span>LOTE EXTERNO</span>
							<input type="text" data-field="LOTE EXTERNO" class="w-full to_uppercase text-gray h-8 lg:hidden">
						</div>
						<div class="col border-l border-b w-full lg:w-[42%]">
							<span>PROVEEDOR</span>
							<input type="text" data-field="PROVEEDOR" class="w-full to_uppercase text-gray h-8 lg:hidden">
						</div>
						<div class="col border-l border-b w-full lg:w-[15%]">
							<span>CADUCIDAD</span>
							<input type="text" data-field="CADUCIDAD" class="w-full to_uppercase text-gray h-8 lg:hidden">
						</div>
					</div>
					...
					<div class="general__col border-r ">
						<div class="col header border-l border-b w-full lg:w-[25%]">
							...
							<input type="text" data-field="NOMBRE DE TRANSPORTISTA" class="w-full to_uppercase mobile-input lg:hidden h-8 text-gray">
						</div>

						<div class="col-hidden border-l border-b w-[40%] px-2">
							<input type="text" data-field="NOMBRE DE TRANSPORTISTA" class="w-full to_uppercase desktop-input h-8">
						</div>
							...
							<?php foreach($section['items'] as $item): ?>
								<div class="list__row border-r">
									...
									<div class="item--alt border-l border-b py-1 px-3 w-[15%] lg:w-[30%]">
										<input type="text" data-section-title="<?= esc($section['title']) ?>" name="items[<?= esc($item['id']) ?>][observacion]" class="w-full h-8 bg-white focus:bg-grayLight " >
...
btn_submit?.addEventListener('click', e => {
	...
	// if(etiqueta.value !== "") {
		...
		const updatedFormData = getCorrectInputValues(itemNumbers, 'form_inspeccion');
		...
		Service.exec('post', `inspeccion/materias-primas`, formData_header, updatedFormData)
		.then(r => {
			if(r.inspeccionId){
