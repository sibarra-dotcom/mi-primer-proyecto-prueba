  	...
  	<?php echo view('dashboard/_partials/navbar'); ?>
		...
		<div class="relative text-title w-full py-2 px-4 lg:px-10 flex items-center justify-between ">
			...
			<div class="hidden lg:flex gap-4 items-center absolute left-6 lg:left-10 top-1/2 -translate-y-1/2">
				<a href="<?= base_url('inspeccion/init/materiales') ?>" class="hover:scale-110 transition-transform duration-100 ">
...
const renderRows = (data) => {
        ...
        row.innerHTML =
            ...
            <td>
							<div class="flex items-center gap-2">
								...
								<a href="${root}/inspeccion/print/materiales/${cell.inspeccion_id}" class=" hover:text-link" ><i class="fas fa-print text-lg"></i></a>
	...
	const form_delete = document.querySelector('#form_delete');
		...
		Service.exec('get', `inspeccion/materiales_delete/${id}`)
		.then( r => {
			if (r.success) {
