<div class="flex items-center space-x-8 ">
  ...
  <a href="<?= base_url('auth/signout') ?>" class="flex gap-x-1" title="Cerrar Sesión">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.4" stroke="currentColor" class="h-8 w-8 stroke-title hover:stroke-error transition duration-300 ">
